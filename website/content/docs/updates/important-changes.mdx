...
The following is a list of the known issues and limitations in Vault Enterprise. 

## Breaking configuration change for disable_mlock ((#disable_mlock-config))

| Change       | Affected version | Affected deployments                     | Fix Versions 
| ------------ | ---------------- | ---------------------------------------- | -------------------- 
| Breaking     | 1.20.0           | Vault instances using integrated storage | See workaround
...
| Change       | Affected version | Affected deployments | Fix versions 
| ------------ | ---------------- | -------------------- | -------------------- 
| New behavior | 1.19.0           | any                  | See workaround 
...
| Change   | Affected version | Affected deployments | Fix versions
| -------- | ---------------- | -------------------- | -------------------- 
| Breaking | 1.19.x           | any                  | See workaround 
...
| Change      | Affected version               | Affected deployments                                                         | Fix versions 
| ----------- | ------------------------------ | ---------------------------------------------------------------------------- | -------------------- 
| Known issue | 1.19.x, 1.18.x, 1.17.x, 1.16.x | HSM-HA configurations migrating from Shamir to HSM-backed unseal/seal wraps. | See workaround 
...
| Change       | Affected version                 | Affected deployments | Fix versions
| ------------ | -------------------------------- | -------------------- | -------------------- 
| New behavior | 1.19.1, 1.18.7, 1.17.14, 1.16.18 | any                  | See workaround 
...
| Change       | Affected version                                                       | Affected deployments | Fix versions 
| ------------ | ---------------------------------------------------------------------- | -------------------- | --------------------
| Known issue  | 1.19.0 - 1.19.1, 1.18.5 - 1.18.7, 1.17.12 - 1.17.14, 1.16.16 - 1.16.18 | any                  | 1.19.3+, 1.18.9+, 1.17.16+, 1.16.20+
...
| Change       | Affected version                                                        | Affected deployments | Fix versions 
| ------------ | ----------------------------------------------------------------------- | -------------------- | --------------------
| Known issue  | 1.19.0 - 1.19.2, 1.18.5 - 1.18.8, 1.17.12 - 1.17.15, 1.16.16 - 1.16.19  | any                  | 1.19.3+, 1.18.9+, 1.17.16+, 1.16.20+
...
| Change       | Affected version                 | Affected deployments | Fix versions 
| ------------ | -------------------------------- | -------------------- | --------------------
| Bug          | 1.16.0, 1.17.13, 1.18.6, 1.19.0  | any                  | 1.19.1+, 1.18.7+, 1.17.14+, 1.16.18+ 
...
| Change       | Affected version | Affected deployments | Fix versions 
| ------------ | ---------------- | -------------------- | --------------------
| Bug          | 1.19.0 - 1.19.2  | any                  | See workaround 
...
| Change       | Affected version                                               | Affected deployments | Fix versions 
| ------------ | -------------------------------------------------------------- | -------------------- | -------------------- 
| Bug          | 1.16.18-1.16.20, 1.17.14-1.17.16, 1.18.7-1.18.9, 1.19.1-1.19.3 | any                  | 1.19.4+, 1.18.10+, 1.17.17+, 1.16.21+
...
| Change       | Affected version                                               | Affected deployments | Fix versions 
| ------------ | -------------------------------------------------------------- | -------------------- | -------------------- 
| Bug          | 1.16.17-1.16.20, 1.17.13-1.17.16, 1.18.6-1.18.9, 1.19.0-1.19.3 | any                  | 1.19.4+, 1.18.10+, 1.17.17+, 1.16.21+ 
...
Add the plugin `.zip` artifact on every node and register the plugin on the
...
| Change | Affected version | Affected deployments | Fix versions 
| ------ | ---------------- | -------------------- | --------------------
| Bug    | 1.19.0-1.19.3    | any                  | See workaround 
